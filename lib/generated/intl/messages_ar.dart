...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m2(double code) => "كود الطلب الخاص بك: #${code}";

  static String m3(double amount) => "الدفع ${amount} جنيه";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "delivery_charges": MessageLookupByLibrary.simpleMessage("رسوم التوصيل :"),
    ...
    "login_to_wikala": MessageLookupByLibrary.simpleMessage(
      "تسجيل الدخول إلى ويكالا",
    ),
    ...
    "orderCode": m2,
    "orderConfirmed": MessageLookupByLibrary.simpleMessage("تم تأكيد طلبك!"),
    "orderDetails": MessageLookupByLibrary.simpleMessage("تفاصيل الطلب"),
    "order_arrived_place": MessageLookupByLibrary.simpleMessage(
      "تم توصيل الطلب إلى مكانك",
    ),
